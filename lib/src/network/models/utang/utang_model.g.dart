...
_$_UtangModel _$_$_UtangModelFromJson(Map<String, dynamic> json) {
  return _$_UtangModel(
    ...
    tglKembali: json['tgl_kembali'] == null ? null : DateTime.parse(json['tgl_kembali'] as String),
...
Map<String, dynamic> _$_$_UtangModelToJson(_$_UtangModel instance) => <String, dynamic>{
